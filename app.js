  ...
  return (
    <div className="header-container">
      <div className="logo-container">
        <img
          className="logo"
          src="https://png.pngtree.com/png-clipart/20241007/original/pngtree-free-food-delivery-logo-template-png-image_16223989.png"
        ></img>
      </div>
    ...
    <div className="body">
      <div style={searchtext} className="search">
        ...
        <button className="search-button" onClick={{}}>
          <img className="search-logo" src={serachIcon}></img>
        </button>
      </div>
      <div className="res-container">{
        resList.map((item)=><ResturantCard key={item.data?.id} resObj={item}/>)
        }</div>
    </div>
  );
};
